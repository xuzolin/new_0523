...
export class fanjiluoxuan_swallowable extends BaseAbility {
    ...
    GetIntrinsicModifierName(): string {
        return modifier_fanjiluoxuan_swallowable.name;
    }
}
//吞噬后的技能buff
@registerModifier()
export class modifier_fanjiluoxuan_swallowable extends BaseModifier {
    ...
    override OnAttackLanded(event: ModifierAttackEvent): void {
        ...
        if (RollPseudoRandomPercentage(50, PseudoRandom.CUSTOM_GENERIC, event.attacker)) {
            this.PlayEffects();
        }
    }
