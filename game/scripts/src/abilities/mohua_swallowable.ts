...
@registerAbility()
export class mohua_swallowable extends BaseAbility {
    GetBehavior(): AbilityBehavior | Uint64 {
        return AbilityBehavior.PASSIVE;
    }

    GetIntrinsicModifierName(): string {
        return modifier_mohua_swallowable.name;
    }
}
//吞噬后的技能buff
@registerModifier()
export class modifier_mohua_swallowable extends BaseModifier {
    ...
    OnIntervalThink() {
        ...
        if (this.cd_remaining <= 0 && parent.IsAlive()) {
            //释放技能
            parent.AddNewModifier(parent, null, "modifier_mohua", {
                duration: duration,
                radius: radius,
...
// 技能效果
@registerModifier()
export class modifier_mohua extends BaseModifier {
    IsHidden(): boolean {
        return false;
    }
    ...
    OnCreated(params: any): void {
        ...
        let transform_particle = ParticleManager.CreateParticle("particles/units/heroes/hero_terrorblade/terrorblade_metamorphosis_transform.vpcf",
